...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Amani, a 3rd-year CSE (AI & ML) student at Mentor Engineering College building small, useful things with Python." },
      { name: "author", content: "Amani" },
      { property: "og:title", content: "Amani — Portfolio" },
      { property: "og:description", content: "3rd-year CSE (AI & ML) student building small, useful things with Python." },
